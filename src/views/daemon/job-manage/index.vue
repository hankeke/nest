...
<script>
import {addObj, delObj, fetchList, isValidTaskName, putObj, refreshJobsRa, runJobRa, shutDownJobRa, shutdownJobsRa, startJobRa, startJobsRa} from '@/api/daemon/sys-job'
