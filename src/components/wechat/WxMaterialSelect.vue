...
<template>
  <div v-if="objData.repType === 'image'">
    <div v-loading="tableLoading" class="waterfall">
      <div v-for="item in tableData" :key="item.mediaId" class="waterfall-item">
    ...
    <avue-crud
      ...
      <template
        ...
        <el-button
          ...
          size="small"
          plain
          @click="selectMaterial(scope.row,objData.appId)">选择
        </el-button>
      </template>
    </avue-crud>
  </div>
  ...
  <div v-else-if="objData.repType === 'news'">
    <div v-loading="tableLoading" class="waterfall">
      <div v-for="item in tableData" v-if="item.content && item.content.newsItem" :key="item.mediaId" class="waterfall-item">
...
import {tableOptionVoice} from '@/const/crud/mp/wx-material-voice'
import {tableOptionVideo} from '@/const/crud/mp/wx-material-video'
