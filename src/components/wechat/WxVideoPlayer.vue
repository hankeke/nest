...
import {getMaterialOther, getTempMaterialOther} from '@/api/mp/wx-material'
  ...
  methods: {
    ...
    getVideo() {
      if (this.objData.type === '2') {
        ...
        this.getTempMaterialOther(this.objData.repMediaId, this.objData.repMediaId + '.mp4', this.objData.appId)
          .then(val => {
